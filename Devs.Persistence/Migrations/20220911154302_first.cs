        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Programming_Language_Name = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Programming_Language_Id = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Technologies_ProgrammingLanguages_Programming_Language_Id",
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "Programming_Language_Name" },
                values: new object[,]
                {
                    { 1, "C#" },
                    { 2, "Java" },
            ...
            migrationBuilder.InsertData(
                table: "Technologies",
                columns: new[] { "Id", "Programming_Language_Id", "Technology_Name" },
                values: new object[,]
                {
                    { 1, 1, "WFA" },
                    { 2, 1, "ASP.NET" },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Technologies_Programming_Language_Id",
                table: "Technologies",
